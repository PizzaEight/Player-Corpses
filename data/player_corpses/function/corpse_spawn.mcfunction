...
execute unless score Config gives_player_head matches 1 as @s at @s if entity @n[type=minecraft:mannequin,tag=player_corpses.corpse,tag=fresh,tag=!player_corpses.poor] run function player_corpses:items_add
