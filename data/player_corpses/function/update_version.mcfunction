execute unless entity @s[scores={player_corpses.version=28}] run tellraw @s {"bold":true,"color":"dark_green","text":"Datapack successfully updated to version 2.8"}
scoreboard players set @s player_corpses.version 28
