...
tp @n[type=#player_corpses:zombie,tag=player_corpses.zombie,tag=fresh] ~ ~0.5 ~
...
execute at @n[type=#player_corpses:zombie,tag=player_corpses.zombie,tag=fresh] run playsound minecraft:entity.zombie.ambient player @a ~ ~ ~ 0.5 0.5
