...
execute as @e[type=minecraft:mannequin,tag=player_corpses.corpse,tag=player_corpses.kept,tag=player_corpses.right_clickable] on passengers run function player_corpses:config/can_be_looted_by_right_clicking/right_clickable_remove 

#Predicate compatability for 26.1 and 26.2
function player_corpses:version_support/right_click_apply/26.1
function player_corpses:version_support/right_click_apply/26.2
