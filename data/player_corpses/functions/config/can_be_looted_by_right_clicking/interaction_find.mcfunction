...
execute if score #interaction player_corpses.interaction matches 1 unless score Config can_only_be_looted_by_owner matches 1 on target run function player_corpses:give_items/get_items 
...
execute if score #interaction player_corpses.interaction matches 1 unless score Config can_only_be_looted_by_owner matches 1 unless score Config has_gore matches 1 on target at @s run playsound minecraft:block.note_block.pling player @s ~ ~ ~ 1 1
