...
execute as @a[scores={config=1019}] run scoreboard players set Config sort_loot_from_corpses 1
...
execute as @a[scores={config=11019}] run scoreboard players set Config sort_loot_from_corpses 0
...
execute as @a[scores={config=1019}] run tellraw @s [{"color":"yellow","text":"Sorts Loot From Corpses: "},{"color":"dark_green","text":"True"}]
...
execute as @a[scores={config=1016}] run tellraw @s [{"color":"yellow","text":"Remove Config Screen Access in Survival was set to: "},{"color":"dark_green","text":"True"}]
...
execute as @a[scores={config=11019}] run tellraw @s [{"color":"yellow","text":"Sorts Loot From Corpses: "},{"color":"dark_red","text":"False"}]
...
execute as @a[scores={config=11016}] run tellraw @s [{"color":"yellow","text":"Remove Config Screen Access in Survival was set to: "},{"color":"dark_red","text":"False"}]
